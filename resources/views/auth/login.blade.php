...
<body class="bg-gray-50 min-h-screen flex flex-col font-sans">
    ...
    <main class="flex-grow flex items-center justify-center p-4">
        ...
        <div class="bg-white rounded-[2rem] shadow-[0_10px_40px_rgba(0,0,0,0.08)] flex flex-col md:flex-row w-full max-w-[900px] overflow-hidden min-h-[500px]">
                ...
                <form action="/login" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="passwordInput" type="password" name="password" placeholder="••••••••••••" class="w-full bg-[#f3f4f6] text-sm text-gray-900 rounded-lg pl-10 pr-10 py-3 focus:outline-none focus:ring-1 focus:ring-[#468770] border-none" required>
                    ...
                    <div class="flex items-center justify-between text-[11px] pt-1">
                        ...
                        <a href="{{ route('password.request') }}" class="text-red-500 hover:text-red-700">Forgot Password</a>
                    </div>
            ...
            <a href="https://www.facebook.com/HeroesChurchPH" class="w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition-colors" target="_blank" rel="noopener">
            ...
            <a href="https://www.youtube.com/@HeroesChurchPH" class="w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition-colors" target="_blank" rel="noopener">
            ...
            <a href="https://www.instagram.com/heroeschurchph/" class="w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition-colors" target="_blank" rel="noopener">
