<x-admin-layout>
    <x-slot:title>Create New Announcement</x-slot:title>
    ...
    <div class="announcement-create-page">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Share important updates with your church community</p>
            </div>

            <form action="{{ route('admin.announcements.store') }}" method="POST" class="form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="body" class="form-input" rows="6" required>{{ old('body') }}</textarea>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="bi bi-check"></i> Create Announcement
                    </button>
