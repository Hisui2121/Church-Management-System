<x-admin-layout>
    <x-slot:title>Edit Announcement</x-slot:title>
    ...
    <div class="announcement-edit-page">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Update announcement details</p>
            </div>

            <form action="{{ route('admin.announcements.update', $announcement->id) }}" method="POST" class="form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="body" class="form-input" rows="6" required>{{ old('body', $announcement->body) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="is_active" class="form-input">
                                <option value="0" {{ old('is_active', $announcement->is_active) == 0 ? 'selected' : '' }}>Inactive</option>
                                <option value="1" {{ old('is_active', $announcement->is_active) == 1 ? 'selected' : '' }}>Active</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="file-input-wrapper">
                                <input type="file" name="image" class="form-input file-input" id="announcementImage" accept="image/*">
                                <label for="announcementImage" class="file-input-label">
                                ...
                                <div class="current-image">
                                    ...
                                    <img src="{{ asset('storage/' . $announcement->image_path) }}" alt="{{ $announcement->title }}" class="current-preview">
                                </div>
                                @endif
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('admin.announcements.index') }}" class="btn btn-secondary btn-lg">
